...
private JTextArea textArea;
	...
	private void initialize() {
		...
		btnGuardar.addMouseListener(new MouseAdapter() {
			...
			String traduccion;
				...
				for(String s: traductorDePalabas.keySet()) {
					textArea.append(s+"-> "+traductorDePalabas.get(s)+"\n");
					
				}
				JOptionPane.showMessageDialog(frame, "Palabra Guardada");
			}
		});
		btnGuardar.setBounds(65, 119, 105, 27);
		...
		btnEliminar.addMouseListener(new MouseAdapter() {
			...
			txtEliminar.setText("");
			JOptionPane.showMessageDialog(frame, "Palabra eliminada");
			}
		});
